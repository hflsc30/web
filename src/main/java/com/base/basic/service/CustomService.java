...
public interface CustomService<T> {
    ...
    @GlobalTransactional
    @MyTransaction
    default R saveBatch(Collection<T> entityList) {
    ...
    @GlobalTransactional
    @MyTransaction
    default R saveOrUpdateBatch(Collection<T> entityList) {
    ...
    @GlobalTransactional
    @MyTransaction
    default R removeById(Serializable id) {
    ...
    @GlobalTransactional
    @MyTransaction
    default R removeById(Serializable id, boolean useFill) {
    ...
    @GlobalTransactional
    @MyTransaction
    default R removeById(T entity) {
        boolean result = SqlHelper.retBool(getBaseMapper().deleteById(entity));
        if (result) {
            return RUtil.success("删除成功");
        } else {
            return RUtil.fail("删除失败");
    ...
    @GlobalTransactional
    @MyTransaction
    default R removeByMap(Map<String, Object> columnMap) {
        Assert.notEmpty(columnMap, "error: columnMap must not be empty");
        boolean result = SqlHelper.retBool(getBaseMapper().deleteByMap(columnMap));
        if (result) {
            return RUtil.success("删除成功");
        } else {
            return RUtil.fail("删除失败");
    ...
    @GlobalTransactional
    @MyTransaction
    default R remove(Wrapper<T> queryWrapper) {
    ...
    @GlobalTransactional
    @MyTransaction
    default R removeByIds(Collection<?> list) {
    ...
    @GlobalTransactional
    @MyTransaction
    default R removeByIds(Collection<?> list, boolean useFill) {
        if (CollectionUtils.isEmpty(list)) {
            return RUtil.fail("删除失败");
        }
        if (useFill) {
    ...
    @GlobalTransactional
    @MyTransaction
    default R removeBatchByIds(Collection<?> list) {
    ...
    @GlobalTransactional
    @MyTransaction
    default R removeBatchByIds(Collection<?> list, boolean useFill) {
    ...
    @GlobalTransactional
    @MyTransaction
    default R removeBatchByIds(Collection<?> list, int batchSize) {
        throw new UnsupportedOperationException("不支持的方法!");
    }
    ...
    @GlobalTransactional
    @MyTransaction
    default R removeBatchByIds(Collection<?> list, int batchSize, boolean useFill) {
        throw new UnsupportedOperationException("不支持的方法!");
    }
    ...
    @GlobalTransactional
    @MyTransaction
    default R update(Wrapper<T> updateWrapper) {
    ...
    @GlobalTransactional
    @MyTransaction
    default R update(T entity, Wrapper<T> updateWrapper) {
     ...
     */
    default R exists(Wrapper<T> queryWrapper) {
        boolean result = getBaseMapper().exists(queryWrapper);
        if (result) {
            return RUtil.success("数据存在");
        } else {
